...
The initial cost of abatement therefore, should be the same as in part b
...
total_tax_revenue_4 <- revnue_antelope_4 + revnue_mojave_4 +revnue_ventura_4 +revnue_kern_4

total_tax_revenue_4

total_tax_revenue_4_v2 <- tax2*300

total_tax_revenue_4_v2
```
