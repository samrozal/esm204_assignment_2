...
Next we calculue the government revenue
...
Therefore, Kern would prefer Cap and Trade, Mojave would prefer a Tax, Antelope would prefer a Tax, and Ventura would prefer Cap and Trade because these are the scenarios/policies that have the lowest cost to each district. 
