...
```{r}
additional_cost <- function(p_before_trade,p_after_trade,q_before_trade,q_after_trade){
  (additional_cost =(0.5)*(p_before_trade-p_after_trade)*(q_before_trade-q_after_trade))
  return(additional_cost)
}

additional_cost_kern <-additional_cost(kern_before_trade, kern_after_trade, 50.07, 69.14)
additional_cost_mojave <- additional_cost(mojave_before_trade, mojave_after_trade,47.32,41.56)
additional_cost_antelope <- additional_cost(antelope_before_trade, antelope_after_trade,74.36,55.31)
additional_cost_ventura <- additional_cost(ventura_before_trade, ventura_after_trade,82.81,89.01)

additional_cost_kern 
additional_cost_mojave 
additional_cost_antelope
additional_cost_ventura
```
